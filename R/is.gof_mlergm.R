...
#'
#' Function checks if a provided object is of class \code{gof_mlergm} (see \code{\link[mlergm]{gof.mlergm}} for details). 
#'
#' @param x An object to be checked. 
#'
#' @return \code{TRUE} if the provided object \code{x} is of class \code{gof_mlergm}, \code{FALSE} otherwise. 
#' @export 
#' @seealso \code{\link[mlergm]{mlergm}}, \code{\link[mlergm]{gof.mlergm}}
